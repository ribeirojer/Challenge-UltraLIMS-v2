...
const Loading = () => {
  return (
    <div className="fixed inset-0 z-50 flex w-full items-center justify-center bg-black bg-opacity-50" role='presentation'>
      <svg
        ...
        fill="#000000"
        viewBox="0 0 256 256"
        className="animate-spin h-20 w-20 fill-white"
