...
export const SortAscending = ({ size = 32, color = "#ffffff" }) => {
 return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} viewBox="0 0 256 256" data-testid="sort-ascending-icon">
...
export const SortDescending = ({ size = 32, color = "#ffffff" }) => {
 return (
   <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} viewBox="0 0 256 256" data-testid="sort-descending-icon">
